...
export const logTraining = mutation({
  ...
  handler: async (ctx, args) => {
    return audited(ctx, { action: "training.log", recordType: "trainingRecords" }, async () => {
      ...
      return { result: id, recordId: id, details: { trainingTitle: args.trainingTitle } };
    });
  },
});
...
export const discardTraining = mutation({
  ...
  handler: async (ctx, args) => {
    return audited(ctx, { action: "training.discard", recordType: "trainingRecords", recordId: args.id }, async () => {
      ...
      return { result: null, details: { reason: args.reason } };
    });
  },
});
...
export const deferTraining = mutation({
  ...
  handler: async (ctx, args) => {
    return audited(ctx, { action: "training.defer", recordType: "trainingRecords", recordId: args.id }, async () => {
      ...
      return { result: null, details: { previousDates, newStartDate: args.newStartDate, newEndDate: args.newEndDate } };
    });
  },
});
